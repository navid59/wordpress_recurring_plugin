...
const BASE_URL_RECURRING_API_LIVE       = "http://localhost:8081/api/v1/";
const BASE_URL_RECURRING_API_SANDBOX    = "http://localhost:8081/api/v1/";
...
const URL_NETOPIA_PAYMENTS_LOGO         = "https://suport.mobilpay.ro/np-logo-blue.svg";
